...
* [bpython](http://bpython-interpreter.org) ¨C A fancy interface to the Python interpreter.
...
* [XGBoost](https://github.com/tqchen/xgboost) - Python bindings for eXtreme Gradient Boosting (Tree) Library
    ...
    * [xpinyin](https://github.com/lxneng/xpinyin) - A library to translate Chinese hanzi (h×Ö) to pinyin (Æ´Òô).
...
* Command-line Application Development
    ...
    * [Clime](http://clime.mosky.tw) ¨C Clime lets you convert any module into a multi-command CLI program without any configuration.
...
* [Grappelli](http://grappelliproject.com) ¨C A jazzy skin for the Django Admin-Interface.
...
* [Cactus](http://github.com/koenbok/Cactus/) ¨C Static site generator for designers.
...
* [pudb](https://pypi.python.org/pypi/pudb) ¨C A full-screen, console-based Python debugger.
